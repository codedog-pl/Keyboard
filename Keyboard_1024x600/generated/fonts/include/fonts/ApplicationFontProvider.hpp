...
{
    static const touchgfx::FontId DEFAULT = 0;  // verdanab_24_4bpp
    static const touchgfx::FontId LARGE = 1;    // verdanab_40_4bpp
    static const touchgfx::FontId SMALL = 2;    // segoeui_10_4bpp
    static const touchgfx::FontId KEYBOARD = 3; // DejaVuSansMono_40_4bpp
